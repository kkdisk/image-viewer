# ==============================================================================
# widgets.py - 自訂 Qt Widgets
# ==============================================================================
"""
包含自訂的 Qt 元件：HistogramWidget、ResizeDialog、MagnifierWindow
"""
...
from PyQt6.QtWidgets import (
    QWidget, QVBoxLayout, QLabel, QDialog, QDialogButtonBox,
    QFormLayout, QSpinBox, QCheckBox
)
from PyQt6.QtGui import (
    QPixmap, QPainter, QColor, QPen, QPainterPath, QBrush, QFont, QPalette
)
