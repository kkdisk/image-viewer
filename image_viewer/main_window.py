...
from PyQt6.QtWidgets import (
    ...
    QListWidget, QListWidgetItem, QTreeWidgetItem, QProgressBar, QStyle
)
from PyQt6.QtGui import (
    QPixmap, QCursor, QResizeEvent, QCloseEvent, QDragEnterEvent, 
    QDropEvent, QKeyEvent, QWheelEvent, QIcon
)
from PyQt6.QtCore import (
    Qt, QSize, pyqtSlot, QObject, QThread, pyqtSignal, QEvent, 
    QThreadPool, QTimer, QPoint
)
...
from .config import Config, LANCZOS_RESAMPLE, NATSORT_ENABLED, natsort
from .workers import requires_image, EffectWorker, ThumbnailWorker, AsyncImageLoader
from .widgets import MagnifierWindow
from .managers import ResourceManager, UIManager, ThemeManager


# ==============================================================================
# ImageEditorWindow - 主視窗
# ==============================================================================
class ImageEditorWindow(QMainWindow):
    ...
    # EXIF 處理
    # ==========================================================================
    def _display_exif_data(self, exif_data) -> None:
